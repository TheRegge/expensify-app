...
// We'll create a different reducers for each root property of state
// THen we'll combine them to create the full store
...
const expenseOne = store.dispatch(addExpense({ description: 'rent', amount: 1100, createdAt: -2100 }));
